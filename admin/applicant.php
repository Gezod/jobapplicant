                                    ...
                                    <div class="data-tables datatable-dark">
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											if(isset($_POST["schedule"])){
													...
													$pic = $_POST['pic'];
													$telp = $_POST['telp'];
													$final = mysqli_query($conn,"insert into applicant_scheduling values('','$ids','$alamat','$tanggal','$pic','$telp');");
														if($final){
																...
																$mail->SMTPAuth = true;
																$mail->Username = 'rekrutmentcoba123@gmail.com';						/////////////////////// ISI DENGAN ALAMAT GMAIL KALIAN
																$mail->Password = 'tuhwmjpvarothmyb';						/////////////////////// ISI DENGAN PASSWORD GMAIL NYA
																
																//Recipients
																$mail->setFrom('noreply@rekrutmentcoba123@gmail.com', 'Job Application');
                                    ...
                                    <div class="data-tables datatable-dark">
										 <table id="dataTable2" class="display" style="width:100%"><thead class="thead-dark">
											...
											if(isset($_POST["hapus2"])){
													...
													if($hapusin){
														unlink($cv);
														echo "<meta http-equcviv='refresh' content='1; URL=applicant.php'> Deleting";
													} else {
														echo "<meta http-equiv='refresh' content='1; URL=applicant.php'> Failed";	
													}
												};
