...
<html>
    ...
    <body style="font-family:verdana">
        ...
        <div class="wraper">
            ...
            <!-- header end -->
            <!-- slider start -->
            <div style="background-image:url('3.jpg');background-repeat:no-repeat; width:100%; height:420px;">
                <div class="container-fluid text-center">
                    <div class="slider-text" style="margin-top:7%; margin-left:45%;">
                        <h2 style="color:black; font-family:Inter">Miarfa's</h2>
						<a href="admin">Masuk sebagai Admin</a>
                    </div>
                </div>
            </div>
            <!-- slider end -->
            ...
            <div class="blog-area pb-70" style="margin-top:5%">
                <div class="container-fluid">
                    <div class="section-title text-center mb-50">
                        ...
                        <p>Pilih di bawah ini yang sesuai dengan posisi yang ingin dilamar</p>
                    </div>
