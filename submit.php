  ...
  if($ukuran_file <= 5000000){ 
    if(move_uploaded_file($tmp_file, $path)){ 
      ...
      if($sql){ 
				...
				$mail->SMTPAuth = true;
				$mail->Username = 'rekrutmentcoba123@gmail.com';
				$mail->Password = 'scvouloudlhlufnc'; // password real:  /ref4ngg40806/ kcjtnpadvmwvwhoy // mxerwsxiycceqqjx // scvouloudlhlufnc

				

				//Recipients
				$mail->setFrom('noreply@gezodarc123@gmail.com', 'Job Application');
